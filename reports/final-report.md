...
- گزارش‌های benchmark ثبت کرده‌اند که اجرای baseline با Python 3.13.3 و اجرای optimized با Python 3.11.8 انجام شده است. Docker، Docker Compose، Elasticsearch، dataset، mapping، seed و محدودیت منابع در گزارش‌ها ثبت و قابل ردیابی‌اند، اما برای یک مقایسهٔ زمانی کاملاً سخت‌گیرانه می‌توان همهٔ benchmarkهای baseline و optimized را دوباره با یک نسخهٔ Python واحد اجرا کرد.
